...
import { LoadingSpinner, Badge } from '@shared/ui';
import { useNavigationStore } from '@features/navigation/model';
...
export function CenterPane() {
  ...
  const demoEvaluation = useMemo(() => {
    ...
    try {
      return evaluateTree(MICA_STABLECOIN_RULE.tree as DecisionNode, facts, 'demo-tree');
    } catch {
      return null;
    }
  }, [store]);
